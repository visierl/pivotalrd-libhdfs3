...
IF(NOT HADOOP_CONFIG_DIR)
SET(HADOOP_CONFIG_DIR "/etc/hadoop/config" "path to the Hadoop configuration files." FORCE)
ENDIF(NOT HADOOP_CONFIG_DIR)
ADD_DEFINITIONS(-DHADOOP_CONFIG_DIR="${HADOOP_CONFIG_DIR}")
